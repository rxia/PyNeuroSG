...
plot_electrode_depth_profile(keyword_tank = '.*160810.*', keyword_blk = '.*retreat.*', ch_index=16, range_ch=np.arange(1, 16+1), range_ch_pos_rel=np.arange(-1500,1,100))
plot_electrode_depth_profile(keyword_tank = '.*160817.*', keyword_blk = '.*retreat.*', ch_index=16, range_ch=np.arange(1, 16+1), range_ch_pos_rel=np.arange(-1500,1,100))
plot_electrode_depth_profile(keyword_tank = '.*160902.*', keyword_blk = '.*retreat.*', ch_index=16, range_ch=np.arange(1, 16+1), range_ch_pos_rel=np.arange(-1500,1,100))
...
plot_electrode_depth_profile(keyword_tank = '.*161202.*', keyword_blk = '.*retreat.*', ch_index=48, range_ch=np.arange(33, 48+1), range_ch_pos_rel=np.arange(-1500,1,100))
plot_electrode_depth_profile(keyword_tank = '.*161206.*', keyword_blk = '.*retreat.*', ch_index=48, range_ch=np.arange(33, 48+1), range_ch_pos_rel=np.arange(-1500,1,100))
plot_electrode_depth_profile(keyword_tank = '.*161228.*', keyword_blk = '.*retreat.*', ch_index=48, range_ch=np.arange(33, 48+1), range_ch_pos_rel=np.arange(-1500,1,100))
plot_electrode_depth_profile(keyword_tank = '.*170103.*', keyword_blk = '.*retreat.*', ch_index=48, range_ch=np.arange(33, 48+1), range_ch_pos_rel=np.arange(-1500,1,100))
plot_electrode_depth_profile(keyword_tank = '.*170221.*', keyword_blk = '.*retreat.*', ch_index=48, range_ch=np.arange(33, 48+1), range_ch_pos_rel=np.arange(-1500,1,100))
